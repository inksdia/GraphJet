...
public class TwitterStreamReader {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        context.addServlet(new ServletHolder(new GraphRenderer(userTweetBigraph, users)),
                "/drawUsers");
        context.addServlet(new ServletHolder(new GraphRenderer(tweetHashtagBigraph, hashtags)), "/drawHash");
